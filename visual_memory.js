...
function finish_test() {
    ...
    score = 0;
    selectedCells = [];
    fetch('submit_result_visualmemory.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded'
        },
        body: `user_id=${USER_ID}&test_id=${TEST_ID}&accuracy_percent=${accuracy.toFixed(2)}&memorization_time_sec=${memorizationSeconds.toFixed(0)}`
    })
