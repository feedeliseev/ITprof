...
$testId = 13; // ID для visual_memory в таблице Tests
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="bg" class="bg_img">
    <div id ='landolt_ring' class="tester">
        ...
        <div id='Scene' class="scene" style="top: 6vh">
            ...
            foreach ($directions as $index => $dir):
                for ($i = 1; $i <= 8; $i++):
                    $id = ($index * 8) + $i;
                    ?>
                    <div class="cell" id="<?= $id ?>" onclick="cell(<?= $index + 1 ?>, <?= $id ?>)">
                        <img src="img/<?= $dir ?>.png" class="cell_img">
                    </div>
                <?php
                endfor;
            endforeach;
        ...
        <a href="landolt_ring.php" class="restart_button" id='Retry'>Заново</a>
    </div>
</div>
