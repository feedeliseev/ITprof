// Убрали константу WAIT_TIME, так как теперь будем получать её из настроек
...
function finish_test() {
    ...
    fetch('submit_result_verbalmemory.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded'
        },
        body: `test_id=11&accuracy_percent=${averageScore.toFixed(2)}`
    })
